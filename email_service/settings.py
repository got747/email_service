...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER",'user@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD",'password')
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False

EMAIL_ADMIN = os.environ.get("EMAIL_ADMIN",'user@gmail.com')

DEFAULT_DOMAIN = '{}://{}:{}'.format(os.environ.get("HOST_PROTOCOL",'http')
            , os.environ.get("HOST_NAME",'localhost')
            , os.environ.get("HOST_PORT",'8000'))
